...
abstract class BaseKeyframeAnimation<K, A> {
  ...
  BaseKeyframeAnimation(long startDelay, long duration, LottieComposition composition,
      List<? extends Keyframe<K>> keyframes) {
  ...
  void setProgress(@FloatRange(from = 0f, to = 1f) float progress) {
    if (progress < getStartDelayProgress() || getDurationRangeProgress() == 0) {
      progress = 0f;
